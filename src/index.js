...
import rain from './raindrop.png';
import fall from './music/fall.mp3';
import summer from './music/summer.mp3';
import spring from './music/spring.mp3';
import winter from './music/winter.mp3';
import bench from './scene.gltf';
import benchbin from './scene.bin';
/**
     * 创建场景对象Scene
     */
...
const background = new THREE.Mesh(new THREE.SphereGeometry(150), new THREE.MeshBasicMaterial({ map: new THREE.CanvasTexture(canvas), side: THREE.BackSide }));
...
//sound init
var springMusic = spring;
var fallMusic = fall;
var summerMusic = summer;
var winterMusic = winter;
...
function summerInit() {
    ...
    texloader.load(rain, function (textureTree) {
